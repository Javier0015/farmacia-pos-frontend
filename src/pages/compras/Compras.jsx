    ...
    <div className="w-full max-w-full overflow-hidden space-y-5 sm:space-y-6 pb-8">
      ...
      <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="px-4 sm:px-6 py-5 border-b border-slate-100">
          ...
          <p className="text-sm text-slate-500">
            Consulta compras, pagos, ticket, productos registrados y cancela compras pendientes.
          </p>
        </div>
            ...
            <table className="w-full min-w-[1280px]">
              <thead className="bg-slate-50/90 border-b border-slate-100">
                <tr>
                  ...
                  <th className="px-5 py-4 text-right text-[11px] font-black text-slate-500 uppercase tracking-wider">
                    Total
                  </th>
                  ...
                  <th className="px-5 py-4 text-center text-[11px] font-black text-slate-500 uppercase tracking-wider sticky right-0 bg-slate-50/95 shadow-[-10px_0_18px_-18px_rgba(15,23,42,0.65)] z-10">
                    Acciones
                  </th>
                </tr>
              </thead>
                    ...
                    >
                      <td className="px-5 py-4 align-middle">
                        <div className="flex items-center gap-3">
                          <div className="w-11 h-11 rounded-2xl bg-sky-50 text-sky-700 flex items-center justify-center shrink-0 group-hover:bg-sky-100 transition-colors">
                      ...
                      <td className="px-5 py-4 align-middle">
                        <div className="flex items-start gap-2 max-w-[220px]">
                          <Truck size={18} className="text-slate-400 mt-0.5 shrink-0" />
                          <div className="min-w-0">
                      ...
                      <td className="px-5 py-4 align-middle">
                        <div className="flex items-start gap-2 max-w-[200px]">
                          <Store size={18} className="text-slate-400 mt-0.5 shrink-0" />
                          <div className="min-w-0">
                      ...
                      <td className="px-5 py-4 align-middle text-right">
                        <div className="inline-flex flex-col items-end rounded-2xl bg-sky-50 px-3 py-2">
                      ...
                      <td className="px-5 py-4 align-middle text-center sticky right-0 bg-white group-hover:bg-sky-50/95 shadow-[-10px_0_18px_-18px_rgba(15,23,42,0.65)] transition-colors">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            onClick={() => verDetalleCompra(compra.id_compra)}
                            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-blue-50 text-blue-700 hover:bg-blue-100 font-black transition"
                            title="Ver detalle"
                          >
                            <Eye size={17} />
                            Ver
      ...
      {modalCompra && (
        <div className="fixed inset-0 z-50 flex items-start justify-center px-3 sm:px-4 py-4 sm:py-8 overflow-y-auto">
          <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm" onClick={cerrarModalCompra} />
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    {items.map((item, index) => {
                      ...
                      return (
                        <div key={index} className="rounded-2xl sm:rounded-3xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                            ...
                            <div className="md:col-span-2 min-w-0">
                              <label className="block text-sm font-bold text-slate-700 mb-2">Precio compra *</label>
                              <input
                                type="number"
                                step="0.01"
                            ...
                            <div className="md:col-span-2 min-w-0">
                              <label className="block text-sm font-bold text-slate-700 mb-2">Desc.</label>
                              <input
                                type="number"
                                step="0.01"
                            ...
                            <div className="md:col-span-2 min-w-0">
                              <label className="block text-sm font-bold text-slate-700 mb-2">Subtotal</label>
                            ...
                            <div className="md:col-span-3 min-w-0">
                              <label className="block text-sm font-bold text-slate-700 mb-2">Fecha caducidad</label>
                              <input
                                type="date"
      ...
      {modalCamara && (
        <div className="fixed inset-0 z-[60] flex items-start sm:items-center justify-center px-3 sm:px-4 py-4 sm:py-8 overflow-y-auto">
          <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm" onClick={() => cerrarCamara(true)} />
      ...
      {modalDetalle && detalleCompra && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center px-3 sm:px-4 py-4 sm:py-8 overflow-y-auto">
          <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm" onClick={cerrarDetalle} />
          ...
          <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-6xl max-h-[92vh] overflow-hidden my-auto">
            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[80vh] space-y-6">
                  ...
                  <>
                    <div className="md:hidden space-y-3">
                      {detalleProductos.map((item) => (
                        <div key={item.id_detalle} className="rounded-2xl border border-slate-100 p-4 bg-white">
                          <p className="font-bold text-slate-800 break-words">{item.producto}</p>
                          <p className="text-xs text-slate-500 mt-1">Lote: {item.lote || '—'}</p>
                          <p className="text-xs text-slate-500 mt-1">Caducidad: {formatoFechaSimple(item.fecha_caducidad)}</p>

                          <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
                            <div className="rounded-xl bg-slate-50 p-3">
                              <p className="text-xs text-slate-500">Cantidad</p>
                              <p className="font-bold text-slate-800">{formatoNumero(item.cantidad)}</p>
                            </div>
                            <div className="rounded-xl bg-slate-50 p-3">
                              <p className="text-xs text-slate-500">Precio</p>
                              <p className="font-bold text-slate-800">{formatoMoneda(item.precio_compra)}</p>
                            </div>
                            <div className="rounded-xl bg-red-50 p-3">
                            ...
                            <div className="rounded-xl bg-sky-50 p-3">
                              <p className="text-xs text-sky-600">Subtotal</p>
                              <p className="font-bold text-sky-700">{formatoMoneda(item.subtotal)}</p>
                            </div>
                          </div>
                        </div>
                      ))}
                      ...
                      <table className="w-full min-w-[850px]">
                        <thead className="bg-slate-50">
                          <tr>
                            ...
                            <th className="px-4 py-3 text-left text-xs font-bold text-slate-500 uppercase">Lote</th>
                            <th className="px-4 py-3 text-left text-xs font-bold text-slate-500 uppercase">Caducidad</th>
                            <th className="px-4 py-3 text-right text-xs font-bold text-slate-500 uppercase">Cantidad</th>
                            <th className="px-4 py-3 text-right text-xs font-bold text-slate-500 uppercase">Precio</th>
                            <th className="px-4 py-3 text-right text-xs font-bold text-slate-500 uppercase">Desc.</th>
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {detalleProductos.map((item) => (
                            <tr key={item.id_detalle}>
                              <td className="px-4 py-3 font-semibold text-slate-800">{item.producto}</td>
                              <td className="px-4 py-3 text-slate-600">{item.lote || '—'}</td>
                              <td className="px-4 py-3 text-slate-600">{formatoFechaSimple(item.fecha_caducidad)}</td>
                              <td className="px-4 py-3 text-right font-bold text-slate-800">{formatoNumero(item.cantidad)}</td>
                              <td className="px-4 py-3 text-right text-slate-700">{formatoMoneda(item.precio_compra)}</td>
                              <td className="px-4 py-3 text-right text-red-700">{formatoMoneda(item.descuento)}</td>
                              <td className="px-4 py-3 text-right font-bold text-sky-700">{formatoMoneda(item.subtotal)}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
              ...
              <section>
                <div className="flex items-center gap-2 mb-4">
                  <Wallet className="text-sky-700 shrink-0" size={22} />
                  <h3 className="text-lg font-bold text-slate-800">
                    Pagos registrados
                  </h3>
                </div>
                    ...
                    <table className="w-full min-w-[700px]">
                      <thead className="bg-slate-50">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left text-xs font-bold text-slate-500 uppercase">Método</th>
                          <th className="px-4 py-3 text-left text-xs font-bold text-slate-500 uppercase">Caja</th>
                          <th className="px-4 py-3 text-left text-xs font-bold text-slate-500 uppercase">Usuario</th>
                          <th className="px-4 py-3 text-right text-xs font-bold text-slate-500 uppercase">Monto</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-slate-100">
                        {detallePagos.map((pago) => (
                          <tr key={pago.id_pago || `${pago.fecha_pago}-${pago.monto}`}>
                            <td className="px-4 py-3 text-slate-600">{formatoFecha(pago.fecha_pago)}</td>
                            <td className="px-4 py-3 font-semibold text-slate-800">{pago.metodo_pago || '—'}</td>
                            <td className="px-4 py-3 text-slate-600">{pago.caja || '—'}</td>
                            <td className="px-4 py-3 text-slate-600">{pago.usuario || '—'}</td>
                            <td className="px-4 py-3 text-right font-bold text-sky-700">{formatoMoneda(pago.monto)}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
              ...
              {detalleCompra.observaciones && (
                <section className="rounded-2xl bg-slate-50 p-4">
                  ...
                  <p className="font-semibold text-slate-800 mt-1 whitespace-pre-wrap">
                    {detalleCompra.observaciones}
                  </p>
                </section>
              )}
