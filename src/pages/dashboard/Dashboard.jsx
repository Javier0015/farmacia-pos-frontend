      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6">
        <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-sm border border-slate-100 min-w-0 overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
            <a
              href="/app/pos"
              className="rounded-2xl border border-slate-200 p-4 hover:border-sky-500 hover:bg-sky-50 transition min-w-0"
            >
              <ShoppingCart className="text-sky-700" />
            ...
            <a
              ...
              className="rounded-2xl border border-slate-200 p-4 hover:border-sky-500 hover:bg-sky-50 transition min-w-0"
            >
              <Package className="text-sky-700" />
              <p className="font-bold text-slate-800 mt-3">
                Nueva compra
              </p>
              <p className="text-sm text-slate-500">
          ...
          <div className="space-y-3 mt-5">
            {[
              ...
              },
              {
                ...
                status: `${resumen.productos_caducidad || 0}`,
              },
            ].map((item) => (
              <div
                key={item.label}
